...
ServerEvents.recipes((event) => {
    ...
    gtr.wooden_simulation("wooden_simulation")
        .inputFluids("gtceu:steam 16000")
        .itemOutputs('64x gtceu:raw_lead',
            '64x gtceu:raw_silver',
            '64x gtceu:raw_galena', 
            '64x gtceu:raw_powellite', 
            '64x gtceu:raw_soapstone', 
            '64x gtceu:raw_malachite', 
            '64x gtceu:raw_hematite', 
            '64x gtceu:raw_yellow_limonite', 
            '64x gtceu:raw_goethite', 
            '64x gtceu:raw_beryllium', 
            '64x gtceu:raw_bentonite', 
            '64x gtceu:raw_basaltic_mineral_sand', 
            '64x gtceu:raw_barite', 
            '64x gtceu:raw_asbestos', 
            '64x gtceu:raw_apatite', 
            '64x gtceu:raw_amethyst', 
            '64x gtceu:raw_alunite', 
            ...
            '64x gtceu:raw_cassiterite_sand', 
            '64x gtceu:raw_calcite', 
            '64x gtceu:raw_cassiterite', 
            '64x gtceu:raw_blue_topaz', 
            '64x gtceu:raw_glauconite_sand', 
            '64x gtceu:raw_garnierite', 
            '64x gtceu:raw_garnet_sand', 
            '64x gtceu:raw_fullers_earth', 
            '64x gtceu:raw_emerald', 
            '64x gtceu:raw_electrotine', 
            '64x gtceu:raw_diatomite', 
            '64x gtceu:raw_diamond', 
            '64x minecraft:raw_copper', 
            '64x gtceu:raw_lapis', 
            '64x gtceu:raw_kyanite',    
            '64x minecraft:raw_iron', 
            '64x gtceu:raw_gypsum', 
            '64x gtceu:raw_grossular', 
            '64x gtceu:raw_green_sapphire', 
            '64x gtceu:raw_graphite', 
            '64x gtceu:raw_granitic_mineral_sand', 
            ...
            '64x gtceu:raw_red_garnet', 
            '64x gtceu:raw_tricalcium_phosphate', 
            '64x gtceu:raw_topaz', 
            '64x gtceu:raw_tin', 
            '64x gtceu:raw_tantalite', 
            '64x gtceu:raw_talc', 
            '64x gtceu:raw_sulfur', 
            '64x gtceu:raw_stibnite', 
            '64x gtceu:raw_spodumene', 
